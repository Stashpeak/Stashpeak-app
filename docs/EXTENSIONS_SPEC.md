...
- [ ] Node/contribution ids are **namespaced** (`${sourceId}:${localId}`). *(`namespaceNodeId` FROZEN in #181; Map = identity passthrough (EV12); call-site + collision-guard test land in #182.)*
